...
const DEFAULT_DATA = {
  menu: [
    // Classiques
    { id: 'm01', cat: 'Classiques', name: 'Burger Local', price: 2000, desc: 'Pain burger, steak haché, salade, oignon, tomate, œuf, fromage, frites, ketchup, mayo', available: true, image: '🍔' },
    ...
    { id: 'm04', cat: 'Classiques', name: 'Fataya Complet', price: 1000, desc: 'Viande hachée, œuf, emmental, frites, ketchup, mayo', available: true, image: '🥟' },
    { id: 'm05', cat: 'Classiques', name: 'Norvégienne', price: 1500, desc: 'Pain hot-dog, frites, ketchup, mayo', available: true, image: '🌭' },
    // Hors-Jeu
    { id: 'm06', cat: 'Hors-Jeu', name: 'Philly Cheese', price: 3000, desc: 'Demi-baguette, viande au choix, oignons et poivrons, frites, sauce bbq, emmental, cheddar', available: true, image: '🥖' },
    { id: 'm07', cat: 'Hors-Jeu', name: 'Chawarma Delux', price: 3000, desc: 'Pain arabe, double portion, tomate, oignon, persil, frites, Tahini, sauce fromagère', available: true, image: '🥙' },
    ...
    // Burgers
    { id: 'm09', cat: 'Burgers', name: 'Burger New-Yorkais', price: 1500, desc: 'Pain burger, sauce burger, steak 150g, cheddar, œuf, salade, tomate, cornichon, oignon confit', available: true, image: '🍔' },
    { id: 'm10', cat: 'Burgers', name: 'Chicken Burger', price: 1500, desc: 'Pain burger, blanc de poulet, cheddar, salade, tomate, cornichon, oignon, mayo, bbq', available: true, image: '🍔' },
    { id: 'm11', cat: 'Burgers', name: 'Miammiam Burger', price: 1500, desc: '2 steaks 150g, 2 cheddar, œuf, salade, oignon confit, sauce miammiam', available: true, image: '🍔' },
    { id: 'm12', cat: 'Burgers', name: 'Burger Royal', price: 2500, desc: 'Pain burger, sauce royale, mayo, salade, tomate, oignon rouge, bacon, viande hachée', available: true, image: '🍔' },
    { id: 'm13', cat: 'Burgers', name: 'Kebab Burger', price: 2500, desc: 'Pain burger, kebab, salade, tomate, oignon, mayo, sauce blanche, cheddar', available: true, image: '🍔' },
    { id: 'm14', cat: 'Burgers', name: 'Grilled Cheese Burger', price: 2500, desc: 'Pain de mie, steak 150g, sauce miammiam, cheddar, emmental, oignon confit, mozzarella', available: false, image: '🥪' },
    // French Tacos
    { id: 'm15', cat: 'French Tacos', name: 'Tacos Poulet', price: 1000, desc: 'Blanc de poulet mariné, cheddar, frites, sauce fromagère', available: true, image: '🌮' },
    { id: 'm16', cat: 'French Tacos', name: 'Tacos Viande Filet', price: 1500, desc: 'Filet de bœuf mariné, cheddar, frites, sauce fromagère', available: true, image: '🌮' },
    { id: 'm17', cat: 'French Tacos', name: 'Tacos Crispy Tenders', price: 1500, desc: 'Crispy tenders, cheddar, frites, sauce fromagère', available: true, image: '🌮' },
    { id: 'm18', cat: 'French Tacos', name: 'Tacos Kebab', price: 1500, desc: 'Émincé de kebab, salade, tomate, oignon, sauce kebab, sauce fromagère', available: true, image: '🌮' },
    { id: 'm19', cat: 'French Tacos', name: 'Tacos Burger', price: 2500, desc: 'Steak 150g, œuf, oignon, salade, tomate, mayo, sauce fromagère, frites', available: true, image: '🌮' },
    { id: 'm20', cat: 'French Tacos', name: 'Tacos Chawarma', price: 2500, desc: 'Viande chawarma, tomate, oignon, persil, frites, sauce fromagère', available: true, image: '🌮' },
    // Pita
    ...
    { id: 'm22', cat: 'Sandwich Pita', name: "L'Américain", price: 3500, desc: 'Pain pita, steak haché, jambon, œuf, salade, tomate, oignon, cheddar, sauce miammiam, frites', available: true, image: '🥙' },
  ...
  orders: [
    {
      ...
      items: [{ id: 'm11', name: 'Miammiam Burger', qty: 2, price: 1500 }, { id: 'm20', name: 'Tacos Chawarma', qty: 1, price: 2500 }],
      subtotal: 5500, deliveryFee: 1000, total: 6500, notes: ''
    },
    {
      ...
      items: [{ id: 'm12', name: 'Burger Royal', qty: 1, price: 2500 }, { id: 'm15', name: 'Tacos Poulet', qty: 1, price: 1000 }],
      subtotal: 3500, deliveryFee: 1000, total: 4500, notes: 'Sans oignons'
    },
    {
    ...
    },
    {
      ...
      items: [{ id: 'm22', name: "L'Américain", qty: 1, price: 3500 }, { id: 'm19', name: 'Tacos Burger', qty: 1, price: 2500 }],
      subtotal: 6000, deliveryFee: 1000, total: 7000, notes: ''
    },
    {
      ...
      items: [{ id: 'm15', name: 'Tacos Poulet', qty: 2, price: 1000 }, { id: 'm04', name: 'Fataya Complet', qty: 1, price: 1000 }],
      subtotal: 3000, deliveryFee: 0, total: 3000, notes: ''
    },
    {
    ...
    },
    {
      ...
      source: 'walkin', payment: 'cash', paymentStatus: 'received',
      items: [{ id: 'm13', name: 'Kebab Burger', qty: 1, price: 2500 }],
      subtotal: 2500, deliveryFee: 0, total: 2500, notes: ''
    },
    {
    ...
    },
    {
      ...
      source: 'web', payment: 'orange_money', paymentStatus: 'received',
      items: [{ id: 'm09', name: 'Burger New-Yorkais', qty: 2, price: 1500 }],
      subtotal: 3000, deliveryFee: 1000, total: 4000, notes: ''
    },
    {
